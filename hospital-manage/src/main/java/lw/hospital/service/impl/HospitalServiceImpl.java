package lw.hospital.service.impl;
...
import lw.hospital.mapper.OrderInfoMapper;
import lw.hospital.mapper.ScheduleMapper;
import lw.hospital.model.OrderInfo;
import lw.hospital.model.Patient;
import lw.hospital.model.Schedule;
import lw.hospital.service.HospitalService;
import lw.hospital.util.ResultCodeEnum;
import lw.hospital.util.YyghException;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) {
        ...
        Schedule schedule = this.getScheduleById(hosScheduleId);
        if(null == schedule) {
    ...
    private Schedule getScheduleById(String frontSchId) {

        return hospitalMapper.selectOne(new QueryWrapper<Schedule>().eq("schedule_id",frontSchId));
    }
