package lw.hospital.order.service.impl;
...
import lw.hospital.api.hospital.HospitalApi;
import lw.hospital.api.patient.PatientApi;
import lw.hospital.common.exception.HospitalException;
import lw.hospital.common.helper.HttpRequestHelper;
import lw.hospital.common.result.ResultCodeEnum;
import lw.hospital.enums.OrderStatusEnum;
import lw.hospital.model.order.OrderInfo;
import lw.hospital.model.user.Patient;
import lw.hospital.order.mapper.OrderMapper;
import lw.hospital.rabbitmq.constant.MqConst;
import lw.hospital.rabbitmq.service.RabbitService;
import lw.hospital.vo.hosp.ScheduleOrderVo;
import lw.hospital.vo.msm.MsmVo;
import lw.hospital.vo.order.*;
import lw.hospital.order.service.OrderService;
import lw.hospital.order.service.WeixinService;
...
public class OrderServiceImpl extends
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        //获取就诊人信息
        Patient patient = patientApi.getPatientOrder(patientId);

        //获取排班相关信息
        ScheduleOrderVo scheduleOrderVo = hospitalApi.getScheduleOrderVo(scheduleId);
        ...
        //获取签名信息
        SignInfoVo signInfoVo = hospitalApi.getSignInfoVo(scheduleOrderVo.getHoscode());
    ...
    public Boolean cancelOrder(Long orderId) {
        ...
        //调用医院接口实现预约取消
        SignInfoVo signInfoVo = hospitalApi.getSignInfoVo(orderInfo.getHoscode());
        if(null == signInfoVo) {
