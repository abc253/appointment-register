...
import lw.hospital.enums.PaymentStatusEnum;
import lw.hospital.enums.PaymentTypeEnum;
import lw.hospital.model.order.OrderInfo;
import lw.hospital.model.order.PaymentInfo;
import lw.hospital.order.mapper.PaymentMapper;
import lw.hospital.order.service.OrderService;
import lw.hospital.order.service.PaymentService;
...
public class PaymentServiceImpl extends
    ...
    @Autowired
    private HospitalApi hospitalFeignClient;
